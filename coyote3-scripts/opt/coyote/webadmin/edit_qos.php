...
<span class="descriptiontext"><b>Note:</b> These settings control how traffic is classified when it passes through the firewall. Traffic rules apply to trafic <em>leaving</em> an interface.</span>
				...
				<table width="100%">
					<tr>
						...
						<td class="labelcellctr"><label>Port</label></td>
						<td class="labelcellctr"><label>Classification</label></td>
	...
	?>
					<tr>
						<td style="text-align: left; background-color: <?=$cellcolor?>;"><?=$qrule["interface"]?></td>
						<td style="text-align: center; background-color: <?=$cellcolor?>;"><?=$qrule["proto"]?></td>
						<td style="text-align: center; background-color: <?=$cellcolor?>;"><?=$qrule["ports"]?></td>
						<td style="text-align: center; background-color: <?=$cellcolor?>;"><?=get_qos_output_prio($qrule["prio"]);?></td>
